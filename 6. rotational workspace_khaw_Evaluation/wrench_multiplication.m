function [wrench] = wrench_multiplication(R_wp, w_p, w_p_t,POI_rot)
...
wrench_p_t = [w_p_t; w_p_t; 0]; %See Eq 3.5 Pott Book (w_p composed from applied force f_p and applied torque t_p)
