...
for counter_b = 1 : size(b_cell, 1) %counter for endeffector design type (line form, square form...)
    ...
    for counter_r = 1 : size(rotation_array, 1)
        ...
        [analysis, workspace_logical] = Arbeitsraum_Verarbeitung_KHAW(a, b, f_min, f_max, grid_n, b_name,  w_p, w_p_t, f_g, counter_analysis, rot_name, analysis, workspace, workspace_logical, R, grid_deg);
