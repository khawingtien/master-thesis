function [ws_bowl_mat, R_x_mat, R_z, R_x] = ws_position_bowl()
...
%Rotation of all orientation around x-axis
    for i=1:30 %orientation 0 to 30°
...
R_z = axang2rotm(rotation_z); 
    ...
    ws_bowl = R_z* ws_orientation(:,index);
%       plot3(ws_bowl(1,:),ws_bowl(2,:),ws_bowl(3,:) ,'ro','LineWidth',1)  %plot rotation     
